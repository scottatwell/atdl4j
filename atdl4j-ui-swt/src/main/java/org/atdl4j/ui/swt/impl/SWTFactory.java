		...
		implements SWTWidgetFactory, SWTPanelFactory
{
	...
	public SWTWidget<?> create(Composite parent, ControlT control, ParameterT parameter, int style) throws JAXBException
	{
		...
		try
		{
			...
			logger.debug( "create(Composite parent, ControlT control, ParameterT parameter, int style) invoked " + "with parms parent: " + parent
	...
	public Map<String, SWTWidget<?>> create(Composite parent, StrategyPanelT panel, Map<String, ParameterT> parameters, int style)
			throws JAXBException
	{
		// TODO 1/19/2010 Scott Atwell added for debug
		logger.debug( "create(Composite parent, StrategyPanelT panel, Map<String, ParameterT> parameters, int style)" + " invoked with parms parent: "
		...
		{
/*** 2/23/2010 Scott Atwell changed to support LINE border			
			// use simple composite
			c = new Composite( parent, style );
***/
			if ( BorderT.LINE.equals(  panel.getBorder() ) )
			{
				// use group
