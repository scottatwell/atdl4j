...
public abstract class ValidationRuleFactory {
		...
		if (edit.getLogicOperator() != null) {
			...
			if (edit.getField() != null) {
				...
				if (edit.getValue() != null) {
					...
					ValidationRule rule = new ValueOperatorValidationRule(field,
							operator, value, parent);
					if (edit.getId() != null)
						refRules.put(edit.getId(), rule);
					...
					ValidationRule rule = new Field2OperatorValidationRule(field,
							operator, field2, parent);
					if (edit.getId() != null)
						refRules.put(edit.getId(), rule);
					...
					// must be EX or NX
					if (operator == OperatorT.EX
						|| operator == OperatorT.NX) {

						ValidationRule rule = new ValueOperatorValidationRule(field,
								operator, null, parent);
						if (edit.getId() != null)
							refRules.put(edit.getId(), rule);
	...
	public static ValidationRule createRule(EditRefT editRef) throws JAXBException {
